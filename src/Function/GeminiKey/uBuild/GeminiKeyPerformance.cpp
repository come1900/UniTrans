...
void testGeminiKey()
{
    ...
    //__CGeminiKeyStackCreate.GeminiKeyCreate(Lock, Unlock, "13359211641994461155", "", "testGeminiKeyCreate", 2048);
...
int createGeminiKey()
{
    ...
    __CGeminiKeyStackCreate.GeminiKeyCreate(Lock, Unlock, "13359211641994461155", GEMINI_KEY_BITS);
    //__CGeminiKeyStackCreate.GeminiKeyCreate(Lock, Unlock, strPID, "", "testGeminiKeyCreate", 2048);
