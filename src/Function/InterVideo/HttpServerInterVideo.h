/*-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-*/
/*
 * HttpServerInterVideo.h - _explain_
 *
 * Copyright (C) 2011 ezlibs.com, All Rights Reserved.
 *
 * $Id: HttpServerInterVideo.h 5884 2013-01-29 03:20:53Z WuJunjie $
 *
 *  Explain:
 *     -explain-
 *
 ...
 */
/*-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-*/
#ifndef _HttpServerInterVideo_H
#define _HttpServerInterVideo_H

#include <HttpdSocket.h>
#include <SocketHandler.h>
#include <ListenSocket.h>
#include <StdoutLog.h>
#include "../Stack/InterVideo/InterVideoStack.h"
...
class CHandlerInterVideo;
class CHttpServerInterVideo : public HttpdSocket
{
public:
    CHttpServerInterVideo(ISocketHandler& h);
    ~CHttpServerInterVideo();
...
private:
    ...
    CConfigInterVideo *m_pCfg;
    CHandlerInterVideo *m_pHandler;
    ...
    //测试接口
    int Do_TestIF( CInterVideoStack &JsonData) ;
    /*-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-*/
    int On_Req_InterVideo_DeviceAdd( CInterVideoStack &restStack);
    int On_Req_InterVideo_DeviceCancel( CInterVideoStack &restStack);
    int On_Req_InterVideo_ValueGet( CInterVideoStack &restStack);
    int On_Req_InterVideo_ValueSet( CInterVideoStack &restStack);
    /*-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-*/
